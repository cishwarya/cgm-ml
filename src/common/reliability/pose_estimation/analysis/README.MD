...
The objective of analyseOutput.py script is to analyse anonrgbtrain_poseestimation_ps_posepoints.json in order to find the missing posepoints and thereby calculating the accuracy.
